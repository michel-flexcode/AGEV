    ...
    <AppLayout>
        <form @submit.prevent="submitForm">
            <div v-for="question in questions" :key="question.model">
                ...
                <select v-if="question.options" v-model="form[question.model]" :id="question.model">
                    <option disabled value="">Sélectionnez une note</option>
                    <option v-for="option in question.options" :value="option.value" :key="option.value">
                        {{ option.text }}
                    </option>
                </select>
                <input v-else type="text" v-model="form[question.model]" :placeholder="question.placeholder">
            </div>
